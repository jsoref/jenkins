...
public class ListViewTest {
    ...
    public void listItemRecurseWorksWithNonTopLevelItems() throws IOException{
        ...
        when(Items.getAllItems(eq(itemGroupOwner), eq(TopLevelItem.class))).thenReturn(Collections.singletonList((TopLevelItem) ig));
    ...
    public void includeRegexProgrammatic() {
        ...
        List<TopLevelItem> igContent = Collections.singletonList((TopLevelItem) it);
